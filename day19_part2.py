...
FILENAME = 'day19_part2.txt'
# FILENAME = 'day19_part2_eg1.txt'
# FILENAME = 'day19_part2_eg2.txt'
...
class Rule():
  ...
  def process(self):
    ...
    if self.attemps >= TRYING_TIMES:
      print(f"sorry, I gave up trying to process rule {self.name}")
      self.fully_processed = True
      self._text = f"sorry, I gave up trying to process rule {self.name}"
...
def get_rules_and_messages(filename):
...
def main():
  rules, messages = get_rules_and_messages(FILENAME)
