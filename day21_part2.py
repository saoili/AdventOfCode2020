...
def get_list(all_allergens):
  allergen_to_ingredient_set = get_ingredient_for_allergens(all_allergens)
  l = []

  for allergen in sorted(allergen_to_ingredient_set.keys()):
    l.append(list(allergen_to_ingredient_set[allergen])[0])
